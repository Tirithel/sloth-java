...
public class PaymentCalculatorTest
{
    ...
    {
        PaymentCalculator.calculatePay(underpaidEmployee.wage, underpaidEmployee.hours);
    ...
    {
        PaymentCalculator.calculatePay(normalEmployee.wage, normalEmployee.hours);
        String result = outContent.toString();
    ...
    {
        PaymentCalculator.calculatePay(overtimeEmployee.wage, overtimeEmployee.hours);
        String result = outContent.toString();
    ...
    {
        PaymentCalculator.calculatePay(overworkedEmployee.wage, overworkedEmployee.hours);
        String result = outContent.toString();
